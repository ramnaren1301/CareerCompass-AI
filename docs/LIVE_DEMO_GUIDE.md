# CareerCompass AI 3.0 — Option-Driven Demo Script
...
Open CareerCompass AI. Point out the six career-area cards and the absence of an open-ended career field.

Say:

> “CareerCompass AI starts with what this version can genuinely support. A student cannot type an unrelated career and accidentally receive fabricated guidance.”
...
CareerCompass AI now displays only:
...
> “The other fifteen fields disappear. CareerCompass AI now goes deeper only inside the chosen direction.”

## 3. Choose the field and role

Select **Robotics**, then **Robotics Engineer**.

CareerCompass AI binds the role to the shared journey and asks what outcome matters first.
...
CareerCompass AI reveals one learning action and one proof project. Confirm the sprint.
...
> “WebMCP is the operating layer behind CareerCompass AI, not another screen the student has to interpret.”
